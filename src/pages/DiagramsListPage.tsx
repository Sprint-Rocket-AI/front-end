        ...
        <div className="mx-auto w-full max-w-[1280px] animate-fade-in px-4">
            <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <button
                    ...
                    className="inline-flex items-center justify-center rounded-xl bg-orange-500 px-5 py-2.5 text-sm font-semibold text-white hover:bg-orange-600 transition shadow-md shadow-orange-500/10 cursor-pointer self-start sm:self-center"
                >
                    + Nuevo Diagrama
                </button>
            </div>
